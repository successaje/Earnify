...
const WalletSidebar = ({ isOpen, onClose, user }) => {
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      setAssets([
        { id: 1, name: 'ICP', symbol: 'ICP', balance: '0.00', value: '$0.00', logo: icpLogo },
        { id: 2, name: 'CKBTC', symbol: 'ckBTC', balance: '0.00', value: '$0.00', logo: ckBTCLogo },
        { id: 3, name: 'CKETH', symbol: 'ckETH', balance: '0.00', value: '$0.00', logo: ckETHLogo },
        { id: 4, name: 'CKUSD', symbol: 'ckUSD', balance: '0.00', value: '$0.00', logo: ckUSDLogo },
      ]);
    }
  }, [isOpen]);
              ...
              <div className="space-y-3">
                ...
                {assets.length > 0 ? (
                  ...
                  <div className="text-center text-gray-500 text-sm">
                    <p className="font-medium">Your wallet is empty</p>
                    <p className="mt-1">Your rewards will show up here when you're paid by a sponsor for a win</p>
                  </div>
                )}
            ...
            <div className="mb-6">
              ...
              {activities.length > 0 ? (
                ...
                <div className="text-center text-gray-500 text-sm">
                  ...
                  <p className="mt-1">All earnings and withdrawals will show up here.</p>
                </div>
              )}
